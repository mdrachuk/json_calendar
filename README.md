...
- **Recurrence engine** — expands `recurrenceRule`, applies
  `recurrenceOverrides`, and yields concrete occurrence instances.
...
`expand` yields the occurrences of an `Event` or `Task` — the date-times
generated by `recurrenceRule` plus the occurrences added, excluded, or
modified by `recurrenceOverrides` — in recurrence id order. The iterator
over an unbounded rule is infinite unless an `end` is given.

```python
from datetime import datetime
from json_calendar import Event, expand

weekly = Event.model_validate(
    {
        "@type": "Event",
        "version": "2.0",
        "uid": "9bfff5b4-3f63-4f45-8451-77f0e977ba82",
        "updated": "2020-01-02T18:23:04Z",
        "title": "Team sync",
        "start": "2020-01-15T13:00:00",
        "timeZone": "America/New_York",
        "recurrenceRule": {"frequency": "weekly"},
        "recurrenceOverrides": {"2020-01-29T13:00:00": {"title": "Planning"}},
    }
)

for occurrence in expand(weekly, end=datetime(2020, 2, 1)):
    print(occurrence.recurrence_id, occurrence.patch)
    instance = occurrence.materialize()  # a standalone Event with recurrenceId

# 2020-01-15 13:00:00 None
# 2020-01-22 13:00:00 None
# 2020-01-29 13:00:00 {'title': 'Planning'}
```
